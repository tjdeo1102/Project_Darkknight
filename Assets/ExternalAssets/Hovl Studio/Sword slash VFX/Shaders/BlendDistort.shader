...
Shader "Hovl/Particles/BlendDistort"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 screenColor132 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_CameraOpaqueTexture,( float4( UnpackScaleNormal( tex2D( _NormalMap, panner146 ), _Distortionpower ) , 0.0 ) + ase_grabScreenPosNorm ).xy);
